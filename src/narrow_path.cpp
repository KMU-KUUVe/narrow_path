...
class Narrow{
	...
	public:
		...
		bool Narrow::cmp(const obstacle_detector::CircleObstacle a, const obstacle_detector::CircleObstacle b);
		  return (a.center.x < b.center.x);

		void Narrow::obstacle_cb(const obstacle_detector::Obstacles data){
			// vector init
